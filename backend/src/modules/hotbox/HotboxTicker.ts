...
// HotboxTicker is used as an interface to processes tick events in classes
export abstract class HotboxTicker {
  startedAt: Date | null
  ...
  startTicks(startedAt: HotboxTicker['startedAt'], crashPoint: number) {
