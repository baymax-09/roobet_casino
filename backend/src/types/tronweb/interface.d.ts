...
declare module 'tronweb/interfaces' {
  ...
  export type ContractType = t.TypeOf<typeof ContractTypeV>

  export type Contract = t.TypeOf<typeof ContractV>

  export type ContractResult = t.TypeOf<typeof ContractResultV>
  ...
  export interface TrxAccount {
    address: string
    balance: number
    frozen: Array<{ frozen_balance: number; expire_time: number }>
    create_time: number
  ...
  export type BlockTransaction = t.TypeOf<typeof BlockTransactionV>
  ...
  export interface Proposal {
    ...
    parameters: Array<Record<string, unknown>> // Assuming the parameters can be of any type
