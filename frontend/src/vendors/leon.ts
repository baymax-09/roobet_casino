  ...
  function (t, r, e) {
    ...
    function o(t, r) {
      var e =
        ...
        i = 0.49 * t.rect.w * r,
        a = 0.49 * (t.rect.h + 220) * r
      return { x: e, y: n, w: i, h: a }
    }
    function f(t, r, e) {
      return { x: t / 2, y: (r - 130 * 0.49 * e) / 2 }
    }
    function l(t, r, e) {
      return {
        r: r,
      ...
      for (r = 0; r < u; r++)
        for (i = (a = t.typo.p[r]).cv.length, e = 0; e < i; e++) {
          if (
            ...
            (f = a.d),
            (c = (l = t.pointsLength.lengths[r]) / t.pointsLength.max),
            (h = 0),
            r > 0)
          )
            for (n = 0; n < r; n++)
              h += t.pointsLength.lengths[n] / t.pointsLength.max
          ;(c += h),
            d.push({
              pos: o,
              drawing: t.drawing,
    ...
    function u(t) {
      for (var r, e, n = t.slice(), i = n.length, a = i; a--; )
        (r = (Math.random() * i) | 0), (e = n[a]), (n[a] = n[r]), (n[r] = e)
      return n
    }
    function d(t, r) {
      var e,
        ...
        a = r.lines.length
      for (e = 0; e < a; e++)
        'a' == (i = (n = r.lines[e]).pos).type
          ? (t.beginPath(),
            t.arc(i.x, i.y, i.radius * n.drawing.value, 0, s),
            t.fill(),
            t.closePath())
          : 'm' == i.type
    ...
    function p(t, r) {
      ...
      for (
        t.restore(), t.save(), t.lineWidth = 1, n = r.typo.p.length, e = 0;
        e < n;
        e++
      )
        v(t, r.typo.p[e], r)
    ...
    function v(t, r, e) {
      var n,
        ...
        o = r.v.length
      for (n = 0; n < o; n++)
        (a = (i = r.cv[n]).addRect(e.rect)),
          'b' == i.type
            ? ((t.fillStyle = '#ff2a00'),
              t.beginPath(),
              t.arc(a.x3 + (a.x3 - a.x2), a.y3 + (a.y3 - a.y2), 1.5, 0, s),
              t.fill(),
              t.beginPath(),
              t.arc(a.x2, a.y2, 1.5, 0, s),
              t.fill(),
              t.beginPath(),
              t.moveTo(a.x2, a.y2),
              t.lineTo(a.x3, a.y3),
              ...
              t.beginPath(),
              (t.fillStyle = '#ffffff'),
              t.arc(a.x3, a.y3, 2.5, 0, s),
              t.fill(),
              t.stroke())
            : (t.beginPath(),
              (t.fillStyle = '#ffffff'),
              (t.strokeStyle = '#ff2a00'),
              t.arc(a.x, a.y, 2.5, 0, s),
              t.fill(),
              t.stroke())
    }
    function g(t, r) {
      ...
      'a' != e.type &&
        ('m' == e.type
          ...
          : 'l' == e.type
            ? t.lineTo(e.x, e.y)
            : 'b' == e.type &&
              t.bezierCurveTo(e.x, e.y, e.x2, e.y2, e.x3, e.y3),
        t.stroke())
    }
    function x(t, r) {
      ...
      for (t.beginPath(), o = 0; o < h; o++) {
        if (((f = r.wavePaths[o]), a)) {
          var p = Math.random() * u - u / 2,
            v = Math.random() * u - u / 2
          ;(f.rx = f.x + p * S(f.rotation)),
            (f.ry = f.y + p * m(f.rotation)),
            (f.sx = f.x + p),
            (f.sy = f.y + v)
        }
        'a' == f.type
            ...
            : f.fix
              ...
              : i < 110
                ? (l = r.wavePaths[o - 1]) &&
                  ((y = l.x + 0.5 * (f.x - l.x)),
                  (c = l.y + 0.5 * (f.y - l.y)),
                  t.quadraticCurveTo(y, c, f.rx, f.ry))
                : t.lineTo(f.rx, f.ry)
      }
      for (t.stroke(), o = 0; o < d.length; o++)
        (f = d[o]), t.beginPath(), t.arc(f.x, f.y, f.radius, 0, s), t.fill()
    }
    function J(t, r, e, n) {
      var i,
        a,
        o = Math.round(r.paths.length * r.drawing.value),
        f = e / 2,
        l = e / 3,
        y = n / 2
      for (i = 0; i < o; i++)
        1 == (a = r.paths[i]).num
          ...
          : (t.fillStyle = '#ff95f8'),
          'a' == a.type
            ? (t.beginPath(), t.arc(a.x, a.y, l, 0, s), t.fill())
            : (t.beginPath(),
              t.save(),
              t.translate(a.x, a.y),
              t.rotate(a.rotation),
    ...
    function N(t, r, e, n) {
      ...
      if (Array.isArray(n[a])) {
        ...
        for (f.addColorStop(o, n[a][0]), s = 0; s < i; s++)
          f.addColorStop(o * (s + 1), n[a][s])
        f.addColorStop(o * (i + 1), n[a][i - 1]),
          (t.strokeStyle = f),
          (t.fillStyle = f)
    ...
    function _(t, r) {
      var e,
        ...
        o = 0
      for (n = 0; n < i; n++)
        (o += (e = w(t, t.typo.p[n].v, r)).l), a.push(e.v), s.push(e.l)
          ...
          0 == n || 'a' == i.type
            ...
            : ((s = f.convert(t, e)),
              ...
              'b' == i.type
                ...
                : (a.distance = W(a.x1, a.y1, a.x2, a.y2))),
          (a.type = i.type),
          (a.rotation = i.ratio.r),
          (a.pat = i.ratio.p),
          (a.fix = i.ratio.f),
          (a.vt = i.ratio.v),
          y.push(a),
    ...
    function R(t, r, e, n, i, a) {
      ...
      if (
        (1 == r.direction && (o = y(1 - i.drawing.value, a, a + s, 1, 0)),
        o > 0)
      ) {
        var f = e * o
        t.setLineDash([e]),
          (t.lineDashOffset = r.direction * (f + e)),
          t.stroke()
      }
      return s
    }
    function j(t, r, e, n) {
      ...
      if (1 == r.drawing.value)
        ...
        for (i = r.drawingPaths.length * r.drawing.value, a = 0; a < i; a++)
          F(t, r.drawingPaths[a], e, n, r.drawing.value)
    }
    function M(t, r, e, n) {
      var i = r.pos
      'a' == i.type
        ? (t.lineStyle(0, n, 0),
          t.beginFill(n),
          t.drawCircle(i.x, i.y, i.radius),
          t.endFill())
        : 'm' == i.type
          ? (t.lineStyle(e, n, 1), t.moveTo(i.x, i.y))
          : 'l' == i.type
            ? t.lineTo(i.x, i.y)
            : 'b' == i.type &&
              t.bezierCurveTo(i.x, i.y, i.x2, i.y2, i.x3, i.y3),
    ...
    function F(t, r, e, n, i) {
      'a' == r.type
        ? (t.lineStyle(0, n, 0),
          t.beginFill(n),
          t.drawCircle(r.x, r.y, r.radius * i),
          t.endFill())
        : 1 == r.start
          ? (t.lineStyle(e, n, 1), t.moveTo(r.x, r.y))
          : t.lineTo(r.x, r.y, 1)
    }
    function G(t, r, e) {
      var n = e.length,
    ...
    function C(t, r) {
      ...
      for (e = 0; e < 6; e++)
        (n = 10 * e + 20),
          ...
          (a[e] = {
            x1: 0.49 * n * r,
            x2: 0.49 * (t.rect.w - 2 * n) * r,
            y1: 0.49 * i * r,
            y2: 0.49 * (t.rect.h - i) * r - 10 * e * 0.49 * r,
          })
      return a
    }
    function L(t, r) {
      ...
      Object.assign(A.prototype, {
        convert: function (t, r) {
          var e = E(this.x, t, this.ratio, r),
            ...
            f = (function (t, r, e) {
              var n = 0
              'a' == t && (n = r.range.cr * e.scale * e.fontRatio)
              return n
            })(this.type, t, r),
            l = new z(this)
          return (
    ...
    function U(t, r, e, n) {
      ...
      for (c = h.length, i = 0; i < c; i++) {
        for (a = (f = h[i]).length, d = [], s = 0; s < a; s++)
          (o = f[s]).rotation != Z && ((n && o.pat) || d.push(o))
        1 == r.typo.p[i].d && d.reverse(),
        ...
        if ('a' == (s = t[n]).type)
          ...
          null !=
            (l = B(
              ...
              s,
              1,
            )) && (u && ((l.type = 'm'), (u = 0)), h.push(l)),
            (X = new z(o))
        else
          for (
            (a = Math.ceil(s.distance / d)) < 3 && (a = 3),
              s.vt && (a = 2),
              i = 1;
            i < a;
            i++
            ...
            (f = i / (a - 1)),
              ...
              0 != s.rotation && 1 == f && (o.rotation = s.rotation),
              s.pat && 1 == f && (o.pat = s.pat),
              s.fix && 1 == f && (o.fix = s.fix),
              a > 0 &&
                null != (l = B(o, X, s, f)) &&
                (u && ((l.type = 'm'), (u = 0)), h.push(l)),
              (X = new z(o))
    ...
    function tt(t, r, e, n, i, a, s, o) {
      ...
      return {
        rect: { w: t, h: 824, fw: r, fh: e },
        ratio: { x1: n, x2: i, y1: a, y2: s },
        p: l,
        clone: function () {
          for (var o = [], f = 0; f < l.length; f++)
            o[f] = { d: l[f].d, v: l[f].v }
          return {
            rect: { w: t, h: 824, fw: r, fh: e },
            ratio: { x1: n, x2: i, y1: a, y2: s },
    ...
    var it = [
        {
          d: -1,
          v: [
            ['m', 0, 352, { x: 0.55, y: 0.3, r: et(0, 352, 143.5, 0) }],
      ...
      at = [
        {
          ...
          v: [
            [
              ...
              320.1,
              {
                r: nt(293.1, 320.1, 262.2, 345, 222.8, 360, 180, 360, 0),
                f: 1,
              },
            ],
      ...
      ct = [
        {
          ...
          v: [
            [
              ...
              0,
              311,
              { r: nt(0, 311, 16.2, 341.6, 49.3, 356, 86, 356, 0), f: 1 },
            ],
      ...
      dt = [
        {
          ...
          v: [
            [
              ...
              0,
              295.4,
              { r: nt(0, 295.4, 17.6, 332.1, 58.3, 360, 110.3, 360, 0), f: 1 },
            ],
      ...
      vt = [
        {
          d: -1,
          v: [
            ['m', 0, 0, { x: 0.6, y: 0.3, r: et(0, 0, 135, 186) }],
            ['l', 135, 186, { r: V, f: 1 }],
      ...
      gt = {
        ...
        K: tt(616, 232, 352, -10, -20, 0, 0, [
          ...
          },
          {
            d: -1,
            v: [
              ['m', 212, 0, { x: 0.7, y: 0.7, r: et(212, 0, 0, 162.5) }],
              ['l', 0, 162.5, { r: Y, p: 1 }],
        ...
        P: tt(568, 210, 352, -10, -10, -0.5, -0.5, [
          {
            d: 1,
            v: [
              ['m', 0, 352, { y: 0, f: 1 }],
        ...
        Q: tt(850, 360, 360, 0, 0, 0, 0, [
          ...
          },
          {
            d: -1,
            v: [
              ['m', 222, 222, { x: 0.5, y: 0.5, r: et(222, 222, 360, 360) }],
              ['l', 360, 360, { x: 0.5, y: 0.5, f: 1 }],
            ],
          },
        ]),
        R: tt(634, 232, 352, -10, -10, -0.5, -0.5, [
          {
            d: -1,
            v: [
              ['m', 0, 186, { r: Y, p: 1 }],
        ...
        U: tt(712, 250, 355, 0, 0, -0.5, -0.5, JSON.parse(JSON.stringify(pt))),
        V: tt(650, 270, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 0, 0, { x: 0.6, y: 0.1, r: et(0, 0, 133.5, 352) }],
        ...
        W: tt(894, 390, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 0, 0, { x: 0.6, y: 0.05, r: et(0, 0, 84.5, 352) }],
        ...
        X: tt(660, 270, 352, 0, 0, 0, -7, [
          {
            d: -1,
            v: [
              ['m', 10, 0, { x: 0.5, y: 0.3, r: et(10, 0, 270, 352) }],
          ...
          },
          {
            d: -1,
            v: [
              ['m', 260, 0, { x: 0.5, y: 0.3, r: et(260, 0, 0, 352) }],
      ...
      bt = [
        {
          ...
          v: [
            ...
            ['b', 52.4, 233.1, 0.5, 181.2, 0.5, 117.1, { r: V }],
            ['b', 0.5, 53, 52.4, 1.1, 116.5, 1.1, { r: Y }],
      ...
      Ot = [
        {
          ...
          v: [
            ...
            ['b', 180.1, 0, 232, 51.9, 232, 116, { r: V }],
            ['l', 232, 222],
            ['b', 234.5, 300.3, 180.2, 338.5, 116, 338, { y: 0.64, r: Y }],
          ...
          v: [
            ...
            [
              ...
              331.5,
              {
                x: 0.5,
                y: 0.64,
                r: nt(0, 331.5, 71.8, 349.6, 116.3, 248.8, 0, 331.5, 0),
                f: 1,
              },
            ],
          ],
        ...
        f: tt(356, 232, 352, -40, -40, 0, 0, [
          {
            ...
            v: [
              [
                ...
                {
                  x: 0.5,
                  r: nt(166.6, 33, 159.3, 13.1, 139.2, 0, 116.9, 0, 0),
                },
              ],
          ...
          },
          {
            ...
            v: [
              [
                ...
                160,
                130,
                { x: 0.7, y: 0, r: et(164, 130, 0, 234.5), f: 1 },
              ],
              ['l', 0, 234.5, { r: Y, p: 1 }],
            ...
            v: [
              ...
              [
                ...
                128.5,
                {
                  x: 0,
                  y: 2,
                  r: nt(119.2, 128.5, 41.9, 101.2, 0, 181, 119.2, 128.5, 0),
                  f: 1,
                },
              ],
            ],
        ...
        v: tt(500, 200, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 0, 130, { x: 0.6, y: -3, r: et(0, 130, 98.5, 352) }],
        ...
        w: tt(700, 310, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 0, 130, { x: 0.6, y: -3, r: et(0, 130, 76.5, 352) }],
              ...
              [
                ...
                156.5,
                130,
                { y: 1, r: et(156.5, 130, 231.5, 352), f: 1, v: 1 },
              ],
        ...
        x: tt(490, 210, 352, 0, 0, 0, -7, [
          {
            d: -1,
            v: [
              ['m', 10, 130, { x: 0.5, y: -1, r: et(10, 130, 210, 352) }],
          ...
          },
          {
            d: -1,
            v: [
              ['m', 200, 130, { x: 0.5, y: -1, r: et(200, 130, 0, 352) }],
              ['l', 0, 352, { x: 0.5, y: 0.5, f: 1 }],
            ],
          },
        ]),
            ...
            v: [
              [
                ...
                68.8,
                {
                  x: 1.2,
                  y: 1.2,
                  r: nt(3.9, 68.8, 16.7, 29, 54.2, 3.1, 98.2, 0.2, 0),
                },
              ],
        ...
        3: tt(580, 222.1, 360, 0, 0, 0, 0, [
          {
            ...
            v: [
              [
                ...
                10.7,
                66.3,
                { r: nt(10.7, 66.3, 11.2, 64.8, 11.7, 63.3, 12.3, 61.8, 0) },
              ],
        ...
        5: tt(596, 208.5, 356, 0, -5, -2, -2, [
          {
            ...
            v: [
              [
                ...
                295.7,
                {
                  r: nt(0, 295.7, 15.3, 333.8, 52.2, 356.2, 97.5, 356, 0),
                  f: 1,
                },
              ],
      ...
      Tt = {
          ...
          { d: 1, v: [['a', 101.174, 93]] },
          {
            ...
            v: [
              [
                ...
                190.3,
                361,
                { r: nt(190.3, 361, 178.3, 451.1, 91.2, 448.8, 190.3, 361, 0) },
              ],
        ...
        $: tt(568, 224, 360, 0, 0, 0, 0, [
          {
            ...
            v: [
              [
                ...
                51.3,
                {
                  r: nt(0, 295.4, 17.6, 332.1, 58.3, 360, 110.3, 360, 0),
                  f: 1,
                },
              ],
        ...
        '·': tt(231, 8, 355, 0, 0, 0, 0, [{ d: 1, v: [['a', 4, 183.5]] }]),
        ...
        '&': tt(660, 259.191, 360, 0, 0, 0, 0, [
          {
            ...
            v: [
              [
                ...
                257.9,
                355,
                { x: 0.5, y: 0.5, r: et(257.9, 355, 52.8, 135.3), f: 1 },
              ],
              ['l', 52.8, 135.3],
        ...
        '.': tt(231, 8, 355, 0, 0, 0, 0, [{ d: 1, v: [['a', 4, 353.5]] }]),
            ...
            v: [
              [
                ...
                20.7,
                {
                  x: 0,
                  y: 0,
                  r: nt(199.4, 20.7, 187.6, 36.6, 168.2, 47.1, 148.2, 47.1, 0),
                  f: 1,
                },
              ],
              [
        ...
        '(': tt(365, 107.865, 360, 0, 0, 0, 0, [
          {
            ...
            v: [
              [
                ...
                {
                  y: 0.8,
                  r: nt(107.9, 360, 39.7, 321.1, 0, 259.8, 0, 182.9, 0),
                  f: 1,
                },
              ],
              ['b', 39.7, 321.1, 0, 259.8, 0, 182.9, { y: 0.8, r: V }],
        ...
        ')': tt(365, 107.865, 360, 0, 0, 0, 0, [
          {
            ...
            v: [
              [
                ...
                {
                  y: 0.8,
                  r: nt(0, 0, 68.2, 38.9, 107.9, 100.2, 107.9, 177, 0),
                },
              ],
              ['b', 68.2, 38.9, 107.9, 100.2, 107.9, 177, { y: 0.8, r: V }],
        ...
        '{': tt(385, 107.865, 360, 0, 0, 0, 0, [
          {
            d: 1,
            v: [
              ['m', 94.5, 360, { x: -0.5, r: Y }],
              ['l', 77.9, 360, { x: -0.5 }],
              ['b', 57.4, 360, 37, 343, 37, 310.7, { x: -0.5 }],
              ['l', 37, 233.4, { x: -0.5 }],
              ['b', 37, 207.9, 24.3, 183.7, 3.8, 180.7, { x: -0.5, r: Y }],
              ['l', 3.8, 179.8, { x: -0.5, r: Y, p: 1 }],
        ...
        '}': tt(385, 107.865, 360, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 13.4, 0.1, { x: -0.5, r: Y }],
              ['l', 30, 0.1, { x: -0.5 }],
              ['b', 50.4, 0.1, 70.8, 17.1, 70.8, 49.4, { x: -0.5 }],
              ['l', 70.8, 126.7, { x: -0.5 }],
              ['b', 70.8, 153.1, 83.6, 176.8, 104, 179.8, { x: -0.5, r: Y }],
              ['l', 104, 180.7, { x: -0.5, r: Y, p: 1 }],
        ...
        '<': tt(423, 90, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 90, 0, { x: -1, y: 0.3, r: et(90, 0, 0, 176) }],
              ['l', 0, 176, { r: V, f: 1 }],
        ...
        '>': tt(423, 90, 352, 0, 0, 0, 0, [
          {
            d: -1,
            v: [
              ['m', 0, 0, { x: -1, y: 0.3, r: et(0, 0, 90, 176) }],
              ['l', 90, 176, { r: V, f: 1 }],
        ...
        Þ: tt(520, 162, 352, -5, -70, 0, 0, [
          ...
          },
          {
            ...
            v: [
              ...
              ['l', 57, 281.6, { x: -0.5, r: Y, f: 1 }],
              ['b', 115, 281.6, 162, 233.4, 162, 175.4, { x: -0.5, r: V }],
              ['b', 162, 117.4, 115, 70.4, 57, 70.4, { x: -0.5, r: Y }],
      ...
      return [
        {
          ...
          v: [
            [
              ...
              0 + e,
              50 + n,
              { r: et(0 + e, 50 + n, 66.5 + e, 0 + n), y: 0, x: 0 },
            ],
            [
              'l',
              66.5 + e,
              0 + n,
              { r: et(0 + e, 50 + n, 66.5 + e, 0 + n), y: 0, x: 0, f: 1 },
            ],
            [
              'l',
              69.5 + e,
      ...
      return [
        {
          ...
          v: [
            ...
            [
              ...
              66.5 + e,
              50 + n,
              { r: et(0 + e, n, 66.5 + e, 50 + n), y: 0, x: 0, f: 1 },
            ],
            [
              'l',
              69.5 + e,
              50 + n,
              { r: et(69.5 + e, 50 + n, 136 + e, n), y: 0, x: 0, f: 1, v: 1 },
            ],
    ...
    var Ut,
      ...
      Kt = {
        Æ: tt(996, 426, 352, 0, 0, 0, 0, [
          {
            ...
            v: [
              ['m', 426, 0, { x: 0, r: Y }],
              ['l', 234, 0, { x: 0.5, f: 1, r: et(234, 0, 0, 352) }],
              ['l', 0, 352, { x: 0.5, y: 0.5, f: 1 }],
            ],
          },
          {
        ...
        À: tt(
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(It(145, -50)),
        ),
        Á: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(Rt(145, -50)),
        ),
        Â: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(jt(145, -100)),
        ),
        Ã: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(Mt(145, -90)),
        ),
        Ä: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(Ft(145, -70)),
        ),
        Å: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(Ct(0, 0)),
        ),
        Ă: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(Gt(145, -110)),
        ),
        Ą: tt(
          620,
          290,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(it)).concat(At(290, 352)),
        ),
        à: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(It(116, -60)),
        ),
        á: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(Rt(116, -60)),
        ),
        â: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(jt(116, -110)),
        ),
        ã: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(Mt(116, -100)),
        ),
        ä: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(Ft(116, -80)),
        ),
        å: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(Ct(-30, 0)),
        ),
        ă: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(Gt(116, -120)),
        ),
        ą: tt(
          600,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(xt)).concat(At(232, 224)),
        ),
        Ć: tt(
          700,
          293.1,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(at)).concat(It(180, -60)),
        ),
        Ĉ: tt(
          700,
          293.1,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(at)).concat(jt(180, -110)),
        ),
        Ċ: tt(
          700,
          293.1,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(at)).concat(Et(180, -80)),
        ),
        Č: tt(
          700,
          293.1,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(at)).concat(qt(180, -110)),
        ),
        Ç: tt(
          700,
          293.1,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(at)).concat(zt(180, 360)),
        ),
        ć: tt(
          520,
          212.1,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(bt)).concat(It(116.5, -68.9)),
        ),
        ĉ: tt(
          520,
          212.1,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(bt)).concat(jt(116.5, -118.9)),
        ),
        ċ: tt(
          520,
          212.1,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(bt)).concat(Et(116.5, -88.9)),
        ),
        č: tt(
          520,
          212.1,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(bt)).concat(qt(116.5, -118.9)),
        ),
        ç: tt(
          520,
          212.1,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(bt)).concat(zt(116.5, 233.1)),
        ),
        Đ: tt(
          721,
          270,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(st)).concat(Lt(0, 176)),
        ),
        Ď: tt(
          721,
          270,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(st)).concat(qt(100, -110)),
        ),
        ď: tt(
          600,
          232,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(St)).concat(
            ((Ut = 300),
            ($t = 0),
            [
              {
        ...
        đ: tt(
          ...
          0,
          0,
          JSON.parse(JSON.stringify(St)).concat(Lt(180, 40)),
        ),
        È: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(It(96, -60)),
        ),
        É: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(Rt(96, -60)),
        ),
        Ê: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(jt(96, -110)),
        ),
        Ë: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(Ft(96, -80)),
        ),
        Ē: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(Xt(96, -80)),
        ),
        Ĕ: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(Gt(96, -120)),
        ),
        Ė: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(Et(96, -80)),
        ),
        Ě: tt(
          520,
          192,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ot)).concat(qt(96, -110)),
        ),
        è: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(It(112, -60)),
        ),
        é: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(Rt(112, -60)),
        ),
        ê: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(jt(112, -110)),
        ),
        ë: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(Ft(112, -80)),
        ),
        ē: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(Xt(112, -80)),
        ),
        ĕ: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(Gt(112, -120)),
        ),
        ė: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(Et(112, -90)),
        ),
        ě: tt(
          570,
          225.5,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(mt)).concat(qt(112, -120)),
        ),
        Ĝ: tt(
          840,
          352,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ft)).concat(jt(180, -110)),
        ),
        Ğ: tt(
          840,
          352,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ft)).concat(Gt(180, -120)),
        ),
        Ġ: tt(
          840,
          352,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ft)).concat(Et(180, -80)),
        ),
        Ģ: tt(
          840,
          352,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ft)).concat(zt(180, 360)),
        ),
        ĝ: tt(
          600,
          232,
          ...
          -117,
          -117,
          JSON.parse(JSON.stringify(Ot)).concat(jt(116, -118.9)),
        ),
        ğ: tt(
          600,
          232,
          ...
          -117,
          -117,
          JSON.parse(JSON.stringify(Ot)).concat(Gt(116, -120)),
        ),
        ġ: tt(
          600,
          232,
          ...
          -117,
          -117,
          JSON.parse(JSON.stringify(Ot)).concat(Et(116, -90)),
        ),
        ģ: tt(
          600,
          232,
          ...
          -117,
          -117,
          JSON.parse(JSON.stringify(Ot)).concat(Rt(116, -70)),
        ),
        Ĥ: tt(
          684,
          232,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(lt)).concat(jt(116, -110)),
        ),
        ĥ: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Jt)).concat(jt(91, -110)),
        ),
        Ì: tt(
          249,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(yt)).concat(It(0, -60)),
        ),
        Í: tt(
          249,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(yt)).concat(Rt(0, -60)),
        ),
        Î: tt(
          249,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(yt)).concat(jt(0, -110)),
        ),
        Ï: tt(
          249,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(yt)).concat(Ft(0, -80)),
        ),
        ì: tt(
          200,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Bt)).concat(It(0, 70)),
        ),
        í: tt(
          200,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Bt)).concat(Rt(0, 70)),
        ),
        î: tt(
          200,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Bt)).concat(jt(0, 10)),
        ),
        ï: tt(
          200,
          0,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Bt)).concat(Ft(0, 50)),
        ),
        Ĵ: tt(
          472,
          172.5,
          ...
          -2,
          -2,
          JSON.parse(JSON.stringify(ct)).concat(jt(172.5, -110)),
        ),
        ĵ: tt(
          220,
          115.9,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Ht)).concat(jt(0, 20)),
        ),
        Ñ: tt(
          721,
          250,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ht)).concat(Mt(125, -100)),
        ),
        ñ: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Nt)).concat(Mt(91, 30)),
        ),
        Ò: tt(
          850,
          360,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ut)).concat(It(180, -60)),
        ),
        Ó: tt(
          850,
          360,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ut)).concat(Rt(180, -60)),
        ),
        Ô: tt(
          850,
          360,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ut)).concat(jt(180, -110)),
        ),
        Õ: tt(
          850,
          360,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ut)).concat(Mt(180, -100)),
        ),
        Ö: tt(
          850,
          360,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(ut)).concat(Ft(180, -80)),
        ),
        Ø: tt(
          850,
          360,
        ...
        ò: tt(
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat(It(116, -60)),
        ),
        ó: tt(
          580,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat(Rt(116, -60)),
        ),
        ô: tt(
          580,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat(jt(116, -110)),
        ),
        õ: tt(
          580,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat(Mt(116, -100)),
        ),
        ö: tt(
          580,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat(Ft(116, -80)),
        ),
        ø: tt(
          580,
          232,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(_t)).concat([
            {
              d: 1,
              v: [
        ...
        Ŝ: tt(
          ...
          0,
          0,
          JSON.parse(JSON.stringify(dt)).concat(jt(112.4, -110)),
        ),
        ŝ: tt(
          400,
          143.808,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(wt)).concat(jt(112.4 * 0.642, -110)),
        ),
        Ş: tt(
          560,
          224,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(dt)).concat(zt(110.3, 360)),
        ),
        ş: tt(
          400,
          143.808,
          ...
          -64,
          -64,
          JSON.parse(JSON.stringify(wt)).concat(zt(70.8126, 231.12)),
        ),
        Ù: tt(
          712,
          250,
          ...
          -0.5,
          -0.5,
          JSON.parse(JSON.stringify(pt)).concat(It(125, -50)),
        ),
        Ú: tt(
          712,
          250,
          ...
          -0.5,
          -0.5,
          JSON.parse(JSON.stringify(pt)).concat(Rt(125, -50)),
        ),
        Û: tt(
          712,
          250,
          ...
          -0.5,
          -0.5,
          JSON.parse(JSON.stringify(pt)).concat(jt(125, -100)),
        ),
        Ŭ: tt(
          712,
          250,
          ...
          -0.5,
          -0.5,
          JSON.parse(JSON.stringify(pt)).concat(Gt(125, -110)),
        ),
        Ü: tt(
          712,
          250,
          ...
          -0.5,
          -0.5,
          JSON.parse(JSON.stringify(pt)).concat(Ft(125, -70)),
        ),
        ù: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Pt)).concat(It(91, 70)),
        ),
        ú: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Pt)).concat(Rt(91, 70)),
        ),
        û: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Pt)).concat(jt(91, 20)),
        ),
        ŭ: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Pt)).concat(Gt(91, 10)),
        ),
        ü: tt(
          520,
          182,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(Pt)).concat(Ft(91, 50)),
        ),
        Ý: tt(
          673,
          270,
          ...
          0,
          0,
          JSON.parse(JSON.stringify(vt)).concat(Rt(135, -60)),
        ),
        ý: tt(
          500,
          225.5,
          ...
          -119,
          -119,
          JSON.parse(JSON.stringify(kt)).concat(Rt(116.3, -60)),
        ),
        ÿ: tt(
          500,
          225.5,
          ...
          -119,
          -119,
          JSON.parse(JSON.stringify(kt)).concat(Ft(116.3, -90)),
        ),
      },
      Qt = Object.assign({}, gt, Wt, Dt, Tt, Kt)
    function Vt(t) {
      var r = (Qt[t] || Qt.tofu).clone()
      return (r.v = t), r
    }
    function Yt(t, r, e, n) {
      var i
          ...
          : n
            ? (function (t, r, e) {
                ...
                for (a = t.length, i = 0; i < a; i++) {
                  for (
                    y = t[i], h = 0, 0, d[u] = [], f = y.length, s = 0;
                    s < f;
                    s++
                  )
                    (c = y[s]),
            ...
            : (function (t, r, e) {
                ...
                for (c = t.length, f = 0; f < c; f++) {
                  for (
                    n = t[f].split(' '), g[v] = [], h = n.length, l = 0;
                    l < h;
                    l++
                  ) {
                    for (p = 0, i = n[l], u = i.length, y = 0; y < u; y++)
                      (a = Vt(i[y])), (s = o(a, r)), (p += s.w)
                    ;(a = Vt(' ')),
                      (s = o(a, r)),
                      (p += s.w),
                      (d += p) > e && ((d = p), (g[(v += 1)] = [])),
                ...
                var x = []
                for (f = 0; f < c; f++)
                  (a = g[f].join(' ').split('')).length > 0 && x.push(a)
                return x
              })(i, r, e)
      )
    }
    ...
    function tr(t) {
      if ('undefined' == typeof Symbol || null == t[Symbol.iterator]) {
        if (
          ...
          (t = (function (t, r) {
            if (!t) return
            if ('string' == typeof t) return rr(t, r)
          ...
          },
          {
            ...
            value: function () {
              var t,
                ...
                e = this.data_.length
              for (t = 0; t < e; t++)
                (r = this.data_[t]).drawingPaths = h(U(this, r, -1, !1), r)
            },
          },
          {
            ...
            value: function (t) {
              var r,
                ...
                n = this.data_.length
              for (r = 0; r < n; r++)
                (e = this.data_[r]).rawPaths = U(this, e, t, !0)
            },
          },
          {
            key: 'updateWavePaths',
            value: function (t) {
              var r,
                ...
                n = this.data_.length
              for (r = 0; r < n; r++)
                (e = this.data_[r]).rawWavePaths = U(this, e, t, !1)
            },
          },
          {
            key: 'updateGuide',
            value: function () {
              var t,
                ...
                e = this.data_.length
              for (t = 0; t < e; t++)
                ((r = this.data_[t]).guide = C(r.typo, this.scale)),
                  (r.grid = L(r.typo, this.scale))
            },
          },
          {
            key: 'update',
              ...
              for (var G, C, L = [], z = 0, A = F; z < A.length; z++) {
                ...
                try {
                  for (X.s(); !(q = X.n()).done; ) {
                    var U = q.value
                    ;(U.alignGapX = G),
                      (U.pointsLength = _(U, this)),
                      L.push(U),
                      (C = { value: 1 }),
                      this.drawing_.push(C),
                      (U.drawing = C)
                    var $,
                      B = tr(U.typo.p)
                    try {
              ...
              for (t = 0; t < e; t++)
                (r = this.data_[t]).rawWavePaths &&
                  ...
                  r.rawPaths &&
                    ...
                    Array.prototype.push.apply(n, r.paths))
              this.paths_ = n
            },
          },
          {
            ...
            value: function () {
              var t,
                r,
                e = this.data_.length
              for (t = 0; t < e; t++) (r = this.data_[t]).lines = c(r)
            },
          },
          {
            key: 'reset',
    ...
    function fr(t, r) {
      return !r || ('object' !== ir(r) && 'function' != typeof r)
        ? (function (t) {
            if (void 0 === t)
        ...
        (n = [
          {
            key: 'on',
            value: function (t, r) {
              or(yr(o.prototype), 'on', this).call(this, t, r), this.update()
            },
          },
          {
            key: 'off',
            value: function (t, r) {
              or(yr(o.prototype), 'off', this).call(this, t, r)
            },
          },
          {
            key: 'position',
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (r = 0; r < n; r++)
                N(t, r, (e = this.model.data[r]), this.color_), d(t, e)
            },
          },
          {
            key: 'drawColorful',
                ...
                (function (t, r, e) {
                  ...
                  for (n = 0; n < d; n++)
                    for (
                      ...
                      'a' == (l = (f = i.lines[a]).pos).type
                        ? (I(t),
                          t.beginPath(),
                          t.arc(l.x, l.y, l.radius * i.drawing.value, 0, s),
                          t.fill(),
                          t.closePath())
                        : 'm' == l.type
                          ? (y = l)
                          : 'l' == l.type
                            ? ((h = W(y.x, y.y, l.x, l.y)) / r.scale > 10 &&
                                (I(t),
                                t.beginPath(),
                                y && t.moveTo(y.x, y.y),
                                t.lineTo(l.x, l.y),
          ...
          },
          {
            ...
            value: function (t, r) {
              ...
              var e,
                ...
                i = this.model.data.length
              for (e = 0; e < i; e++)
                N(t, e, (n = this.model.data[e]), this.color_),
                  O(
                    t,
                    n,
                    this.model.scale,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (r = 0; r < e; r++) x(t, this.model.data[r])
            },
          },
          {
            key: 'point',
            value: function (t) {
              var r,
                e = this.model.data.length
              for (r = 0; r < e; r++) p(t, this.model.data[r])
            },
          },
          {
            key: 'box',
